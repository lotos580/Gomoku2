...
public class Game {
   ...
   public boolean isCellOK(int num)
    ...
    public void startGameComputerVsComputer()
    {
        int numberOfTurn = 1;  
    ...
    public void initCombination()
    {
        ...
        Combination semiClosedQuadrWithBreach1 = new Combination(2000, comb5, 2);
        ...
        Combination semiClosedQuadrWithBreach3 = new Combination(2000, comb7, 3);
        ...
        Combination semiClosedQuadrWithBreach5 = new Combination(2000, comb9, 4);
